...
#Most codes were modifed from the Weight Gene Correlation Network Analysis (WGCNA) tutorial https://horvath.genetics.ucla.edu/html/CoexpressionNetwork/Rpackages/WGCNA/ 
...
#Save the data frame:
save(geneInfoPRAD_1, file = "Data Outputs/PRAD_geneMM.Rdata")
#################################################################################################
...
#Save the data:
save(connectivity_PubMed_COAD, file = "Data Outputs/Scaled connectivity and PubMed ID for COAD.Rdata")
#################################################################################################

# We also create a data frame containing scaled connectivity and aggressiveness score:
...
save(geneInfoGBMLGG_1, file = "Data Outputs/GBMLGG_geneMM.Rdata")
#################################################################################################
...
#Save the data:
save(connectivity_PubMed_GBMLGG, file = "Data Outputs/Scaled connectivity and PubMed ID for GBMLGG.Rdata")
#################################################################################################
...
save(annotation_bymodule, file = "Data Outputs/Annotation by module PRAD.Rdata")
#################################################################################################
...
#Calcualte Kendall correlation between scaled connectivity and PubMed publications for PRAD:
corAndPvalue(connectivity_PubMed_PRAD$PubMed, connectivity_PubMed_PRAD$scaledconnectivity, method = "kendall")

#Calcualte Kendall correlation between scaled connectivity and PubMed publications for COAD:
corAndPvalue(connectivity_PubMed_COAD$PubMed, connectivity_PubMed_COAD$scaledconnectivity, method = "kendall")

#Calcualte Kendall correlation between scaled connectivity and PubMed publications for GBMLGG:
...
# Calculate Kendall correlation between Gleason score and number of PubMed publications for PRAD:
corAndPvalue(Gleason_connectivity_PubMed_PRAD$PubMed, Gleason_connectivity_PubMed_PRAD$GleasonScore, method = "kendall")

#Calculate Kendall correlation between aggressiveness score and number of PubMed publications for COAD:
...
# Calculate Kendall correlation between Cindex score and number of PubMed publications for GBMLGG:
